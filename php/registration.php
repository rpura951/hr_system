<?php
    ...
    if(isset($_POST['Create']))
    {
        ...
        {
            echo("E-mail does not meet proper requirements");
            exit;
        }
        else
        {
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form method="post" enctype="multipart.form-data">
                <table style="border: 70px;">
                    ...
                    <tr>
                        <td style="width100px; text-align:left;">E-mail Address</td>
                        <td><input type="text" name="emal" required size="20" maxlength="20" /></td>
                    </tr>
                    <tr>
                        <td style="width100px; text-align:left;">Address</td>
